...
const createUser = async (req, res) => {
  try {
      ...
      const user = new User({
          ...
          phoneNumber, gender, jobType, workType, experienceLevel, role, bio,
...
module.exports = { createUser,checkEmailExists, getUser, updateUser, deleteUser, getUserById, requestPasswordReset, resetPassword };
